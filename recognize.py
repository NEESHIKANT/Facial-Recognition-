...
classifier = cv2.CascadeClassifier(r"C:\Users\KIIT\Desktop\STUDY\PROJECT 1\Face Detect\haarcascade_frontalface_default.xml")

model = load_model(r"C:\Users\KIIT\Desktop\STUDY\PROJECT 1\Face Detect\final_model (1).h5")

URL = 'http://192.168.1.5:8080/shot.jpg'

def get_pred_label(pred):
    labels = ["Neeshikant","Sandhya","Smruti"]
    return labels[pred]
